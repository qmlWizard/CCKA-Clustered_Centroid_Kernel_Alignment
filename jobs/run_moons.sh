...
python3 main.py --config configs/comparision/moons.yaml
python3 main.py --config configs/comparision/moons_quack.yaml
python3 cross_validate.py --config configs/cross_validation/moons.yaml
